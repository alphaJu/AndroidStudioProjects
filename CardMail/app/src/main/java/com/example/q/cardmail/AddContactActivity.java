...
public class AddContactActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isUpdate) {
            ...
            btnAddContact.setText("Edit Contact");
        ...
        btnAddContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (btnAddContact.getText().toString().equals("Edit Contact")) {
    ...
    private void selectImage() {
        ...
        final CharSequence[] option = {"Choose from Gallery"};
...
/*
                ...
                if (option[item].equals("Choose from Gallery"))
                {
    ...
    public void addContact() {
        ...
        if (rotateBitmap != null) {    // If an image is selected successfully
            ...
            rotateBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.minion_default_contact) ;
            rotateBitmap.compress(Bitmap.CompressFormat.PNG, 75, stream);
            insertOperation.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI)
                    .withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactID)
                    .withValue(ContactsContract.Data.IS_SUPER_PRIMARY, 1)
        ...
        try {
            ...
            if (isButtonClicked == true) {
                ...
                imgContactPhoto.setImageResource(R.drawable.minion_default_contact);
        ...
        try {
            ...
            if (rotateBitmap != null) {    // If an image is selected successfully
                ...
                ops.add(ContentProviderOperation.newUpdate(ContactsContract.Data.CONTENT_URI)
                        ...
                        .build());
                /*
                rotateBitmap.compress(Bitmap.CompressFormat.PNG, 100, image);
                ops.add(ContentProviderOperation.newUpdate(ContactsContract.Data.CONTENT_URI)
                        .withSelection(ContactsContract.Data.CONTACT_ID + "=? AND" + ContactsContract.Data.MIMETYPE + "=?",
                                new String[]{contactID, ContactsContract.CommonDataKinds.Photo.CONTENT_ITEM_TYPE})
                        .withValue(ContactsContract.Data.IS_SUPER_PRIMARY, 1)
